...
See .env.example for ACCESS_TOKEN, PORT, STREAM_TIMEOUT_SEC, MOCK_CAMERA, DECODER_URL, DEVICE_ID=89370567, CAMERA_USERNAME=admin, CAMERA_PASSWORD, SOURCE=cloud.
Never commit .env.
